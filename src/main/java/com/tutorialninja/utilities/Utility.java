...
public class Utility extends ManageBrowser {
    ...
    public void selectAndClickOnTheElementFromTheList(List<WebElement> element, String text) {

        for (WebElement title : element) {
    ...
    public List<String> getTheListOfElementFromTheList(List<WebElement> productTitles){
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/tutorialninja/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/tutorialninja/screenshots/" + screenshotName + dateName + ".png";
